...
/* Poets-App: log, voorraad, chat, tips */
.dl-card-h {
  font-size: 15px;
  font-weight: 600;
  color: #7a5a1a;
...
.pt-row {
  ...
  gap: 10px;
  padding: 9px 0;
  border-bottom: 1px solid rgba(36,29,16,0.12);
}
...
.pt-empty {
  color: rgba(36,29,16,0.5);
  font-size: 13px;
  text-align: center;
  padding: 16px 0;
}
.pt-warn { color: #8a3b1f; }
...
.pt-chip:hover { border-color: #b8892b; }
.pt-chip-on {
  background: #2f7d5b;
  border-color: #2f7d5b;
  color: #f2fbf6;
...
.pt-toggle-on { background: #2f7d5b; }
.pt-toggle-dot {
  position: absolute;
  top: 2px;
  left: 2px;
...
.pt-toggle-on .pt-toggle-dot { left: 20px; }

.pt-frag {
  background: rgba(36,29,16,0.04);
  border: 1px dashed rgba(36,29,16,0.3);
  border-radius: 10px;
  padding: 10px;
  margin-bottom: 10px;
}
.pt-frag-src {
  ...
  max-height: 70px;
  overflow: auto;
  border-left: 2px solid rgba(36,29,16,0.3);
  padding-left: 8px;
  margin-bottom: 8px;
}
...
.pt-note {
  background: rgba(138,59,31,0.08);
  border-left: 3px solid #8a3b1f;
  padding: 8px 10px;
  margin-top: 8px;
  font-size: 12px;
  border-radius: 4px;
