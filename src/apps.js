...
import {
  ...
  AudioLines, UserRound, AlertTriangle, Gamepad2, Sparkles,
} from "lucide-react";
...
export const APPS = [
  ...
  { key: "opruim", name: "Opruimen", tagline: "alles schoon in één druk", icon: Sparkles, accent: "#0891b2", bright: "#22d3ee" },
];
